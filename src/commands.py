...
def help():
    return (
        ...
        + "Вітання! 🤖 "
        + os.linesep
        + "Я бот для допомоги біженцям з України 🇺🇦 у Німеччині."
        + os.linesep
        + "Більшість моїх знань відносяться до Берліна, але є й загальна "
        + "корисна інформація. Щоб побачити список команд, що підтримуються, "
        + "введіть символ '/'. "
        + "\n\n"
        + "Якщо додайте мене до свого чату, не забудьте дати мені права адміна, "
        + "будь ласка, щоб я міг видаляти непотрібні повідомлення із "
